package com.shandilya.emailReader.constants;

public class EmailConstants {

    private EmailConstants() {}

    public static final String GMAIL_PROPS = "/Users/shandilya/IdeaProjects/emailReader/src/main/resources/email.properties";
